            ...
            <Content>
                ...
                <ContentContainer>
                    ...
                    <LogoContainer>
                        ...
                        <ButtonContainer>
                            <ButtonUI onClick={() => setLogoOne(true)} style={{ background: logoOne ? '#51B27E' : 'black' }}></ButtonUI>
                            <ButtonUI onClick={() => setLogoOne(false)} style={{ background: logoOne ? 'black' : '#51B27E' }}></ButtonUI>
                        </ButtonContainer>
                    </LogoContainer>
                </ContentContainer>
                ...
                <ContentContainer>
                    ...
                    <LogoContainer>
                        ...
                        <ButtonContainer>
                            ...
                            <ButtonUI onClick={() => setLogoTwo(false)} style={{ background: logoOne ? 'green' : 'black' }}></ButtonUI>
                        </ButtonContainer>
                    </LogoContainer>
                </ContentContainer>
